        ...
        <div class="relative w-full max-w-[460px] rounded-[20px] bg-white p-6 shadow-brand-lg sm:p-9 max-h-[90dvh] overflow-y-auto">
          ...
          @if (showOtpStep()) {
            ...
            <div class="mt-2 grid grid-cols-1 gap-2">
              <button type="button" disabled class="relative inline-flex items-center justify-center gap-1.5 rounded-lg border-[1.5px] border-line bg-white px-2 py-3 text-[13px] font-medium text-muted-2 cursor-not-allowed min-h-[44px]" [attr.aria-label]="'auth.social.facebookComingSoon' | translate">
