  ...
  template: `
    <div class="sticky top-6 space-y-4">
      <div class="rounded-2xl border border-line bg-white p-5 shadow-brand-sm">
        <div class="mb-3 inline-flex items-center gap-1.5 rounded-pill bg-emerald-50 px-2.5 py-1 text-[11px] font-semibold text-emerald-700">
        ...
        <button type="button" class="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-pill bg-brand-700 px-5 py-3 text-sm font-bold text-white shadow-brand-sm hover:bg-brand-800">
        ...
        <div class="flex items-start gap-3">
          ...
          <div class="min-w-0">
            ...
            <div class="mt-1 flex items-center gap-1 text-xs text-muted">
              <svg viewBox="0 0 24 24" width="11" height="11" fill="currentColor" class="text-amber-500" aria-hidden="true"><path d="M12 2l3 6.5 7 1-5 5 1.2 7L12 17.8 5.8 21.5 7 14.5l-5-5 7-1L12 2z"/></svg>
